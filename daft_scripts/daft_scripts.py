...
from daft_scripts_utils.map_gen  import map_gen
from daft_scripts_utils.move_file import move_file
from daft_scripts_utils.open_html import open_html
from daft_scripts_utils.input_form import run_input_form
from daft_scripts_utils.read_json import read_json
from daft_scripts_utils.add_time import add_time
...
move_file(outputFolder,"\outputs","result.txt")
move_file(outputFolder,"\outputs","ireland_rent.html")
